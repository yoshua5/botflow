...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='bots' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.bots FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='bots' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.bots FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='bot_configs' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.bot_configs FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='bot_configs' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.bot_configs FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='bot_secrets' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.bot_secrets FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='bot_secrets' AND policyname='deny_all_authenticated') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='phone_mappings' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.phone_mappings FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='phone_mappings' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.phone_mappings FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='conversations' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.conversations FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='conversations' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.conversations FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='knowledge_files' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.knowledge_files FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='knowledge_files' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.knowledge_files FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='knowledge_content' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.knowledge_content FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='knowledge_content' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.knowledge_content FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='analytics' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.analytics FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='analytics' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.analytics FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='message_events' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.message_events FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='message_events' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.message_events FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='subscriptions' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.subscriptions FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='subscriptions' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.subscriptions FOR ALL TO authenticated USING (false);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='appointments' AND policyname='deny_all_anon') THEN
    CREATE POLICY "deny_all_anon" ON public.appointments FOR ALL TO anon USING (false);
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename='appointments' AND policyname='deny_all_authenticated') THEN
    CREATE POLICY "deny_all_authenticated" ON public.appointments FOR ALL TO authenticated USING (false);
  END IF;
END $$;


-- ============================================================
-- PARTE D: TABLAS AD-HOC
-- ============================================================
